    ...
    ERC1155Holder
{
  ...
  */
    ...
    event TokenSend(
        uint256 tokenAmount,
        uint256 etherAmount,
        uint256 amountSuper721,
        uint256 amountSuper1155
    );
  ...
  */
    function changePanicDetails(address _panicOwner, address _panicDestination)
        external
        nonReentrant
        onlyOwner
    {
     ...
     */
    function addSuper1155Addr(address[] calldata _super1155)
        external
        onlyOwner
    {
     ...
     */
    function addTokens(address[] calldata _contrAddrs, Asset[] calldata _assets)
        external
        nonReentrant
        onlyOwner
    {
