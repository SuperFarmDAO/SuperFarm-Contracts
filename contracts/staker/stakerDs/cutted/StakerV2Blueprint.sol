...
/**
 * @title Blueprint library for StakerV2.
...
library StakerV2Blueprint {
    ...
    /**
     * This struct defines the state variables for StakerV2Proxy.
     *
    ...
    // Storage Locations
    function stakerV2StateVariables()
        internal
        pure
        returns (StakerV2StateVariables storage _stakerV2StateVariables)
    {
        bytes32 storagePosition = keccak256("diamond.storage.StateVariables");
        assembly {
            _stakerV2StateVariables.slot := storagePosition
        }
    }
}
