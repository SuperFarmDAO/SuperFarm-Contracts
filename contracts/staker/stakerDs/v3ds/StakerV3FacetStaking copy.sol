...
//  */
// contract StakerV3FacetStakingCopy is
//     Sweepableds,
//     ReentrancyGuard,
//     ERC1155Holder,
//     IERC721Receiver
...
//         for (uint256 i; i < b.poolLocks[_poolId].length; i++) {
//             if (
...
//                 b.poolLocks[_poolId][i] = b.poolLocks[_poolId][
//                     b.poolLocks[_poolId].length
//                 ];
//                 b.poolLocks[_poolId].pop;

//                 _user.tokenRewards +=
//                     (((_user.tokenBoostedAmount * tokensReward) /
//                         b.poolInfoV3[_poolId].tokenBoostedDeposit) / 1e12) -
//                     _user.tokenPaid;
//                 _user.pointRewards +=
//                     (((_user.pointBoostedAmount * pointsReward) /
//                         b.poolInfoV3[_poolId].pointBoostedDeposit) / 1e30) -
//                     _user.pointPaid;
