...
/**
  @title An interface for the `Super721` ERC-721 item collection contract.
  @author 0xthrpw
  @author Tim Clancy
...
interface ISuper721 {
  ...
  /// The public symbol of this contract.
  function symbol () external view returns (string memory);

  /**
    An ERC-1155 URI for tracking item metadata, supporting {id} substitution.
  ...
  */
  ...
  /// A mapping from each token ID to per-address balances.
  ...
  */
  ...
  /**
    Retrieve the balance of a held tokens for a particular address `_owner`.
