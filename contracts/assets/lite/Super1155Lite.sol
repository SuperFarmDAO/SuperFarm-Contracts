...
PermitControl, ERC165Storage, IERC1155, IERC1155MetadataURI {
  ...
  /** 
    The ERC-1155 URI for tracking item metadata, 
  ...
  */
  ...
  /// A mapping that keeps track of total balances of owners.
  ...
  /**
    @dev This is a mapping from each address 
  ...
  /** 
    A mapping of token ID to a boolean representing 
  ...
  */
  ...
  /** 
    A public mapping of optional on-chain metadata for 
