    ...
    IERC1155MetadataURI
{
  ...
  */
    struct ItemGroup {
        ...
        uint256 supplyData;
        uint256 itemData;
        Data.ItemGroupTimeData timeData;
        Data.ItemGroupTransferData transferData;
        Data.ItemGroupIntrinsicData intrinsicData;
  ...
  */
    event ItemGroupConfigured(
        ...
        uint256 groupId,
        Data.ItemGroupInput indexed newGroup
    );
    ...
    function safeBatchTransferFrom(
        ...
        for (uint256 i = 0; i < _ids.length; ++i) {
            ...
            if (
                ...
                Data.TransferType.BoundToAddress
            ) {
            ...
            if (
                itemGroups[groupId].transferData.transferFeeType ==
                Data.TransferFeeType.PerTransfer
            ) {
                bool paid;
                ...
                if (!paid) {
                    ...
                    IERC20(itemGroups[groupId].transferData.transferToken)
                        .safeTransferFrom(
                            _from,
                            owner(),
                            itemGroups[groupId].transferData.transferFeeAmount
                        );
                }
            } else if (
                itemGroups[groupId].transferData.transferFeeType ==
                Data.TransferFeeType.PerItem
            ) {
                if (itemGroups[groupId].itemType == Data.ItemType.Fungible) {
                    IERC20(itemGroups[groupId].transferData.transferToken)
                        .safeTransferFrom(
                            _from,
                            owner(),
            ...
            if (
                ...
                balances[_ids[i]][owner()] =
                    balances[_ids[i]][owner()] +
                    ratioCut;
                groupBalances[groupId][owner()] =
                    groupBalances[groupId][owner()] +
                    ratioCut;
    ...
    function configureGroup(
        ...
        if (!itemGroups[_groupId].initialized) {
            ...
            if (itemGroups[_groupId].supplyType == Data.SupplyType.Capped) {
                ...
                itemGroups[_groupId].timeData.timeInterval = _data
                    .timeData
                    .timeInterval;
                itemGroups[_groupId].timeData.timeRate = _data
                    .timeData
                    .timeRate;
            ...
            itemGroups[_groupId].transferData.transferTime = _data
                .transferData
                .transferTime;
            itemGroups[_groupId].transferData.transferFeeAmount = _data
                .transferData
                .transferFeeAmount;
            itemGroups[_groupId].transferData.transferType = _data
                .transferData
                .transferType;

            // Update intrinsic value information.
            if (
                itemGroups[_groupId].intrinsicData.intrinsic &&
                itemGroups[_groupId].circulatingSupply == 0
            ) {
                itemGroups[_groupId].intrinsicData.rate = _data
                    .intrinsicData
                    .rate;
                itemGroups[_groupId].intrinsicData.burnShare = _data
                    .intrinsicData
                    .burnShare;
        ...
        if (
            ...
            itemGroups[_groupId].intrinsicData.prefund += _data
                .intrinsicData
                .prefund;
            itemGroups[_groupId].intrinsicData.totalLocked += _data
                .intrinsicData
                .prefund;
  ...
  */
        ...
        returns (uint256)
    {
        ...
        if (itemGroups[groupId].burnType == Data.BurnType.Replenishable) {
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            ...
            if (itemGroups[groupId].supplyType == Data.SupplyType.TimeValue) {
                ...
                if (
                    itemGroups[groupId].supplyData >
                    itemGroups[groupId].timeData.timeCap
                ) {
                    itemGroups[groupId].supplyData = itemGroups[groupId]
                        .timeData
                        .timeCap;
                }
            }
            ...
            if (itemGroups[groupId].intrinsicData.intrinsic) {
                uint256 requiredAmount = _amounts[i] *
                    itemGroups[groupId].intrinsicData.rate;
                address intrinsicToken = itemGroups[groupId]
                    .intrinsicData
                    .intrinsicToken;

                // If sufficient prefund is available.
                if (
                    requiredAmount <= itemGroups[groupId].intrinsicData.prefund
                ) {
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            ...
            if (itemGroups[groupId].intrinsicData.intrinsic) {
                ...
                uint256 burnShare = (burnAmount *
                    itemGroups[groupId].intrinsicData.burnShare) / 10000;
                address intrinsicToken = itemGroups[groupId]
                    .intrinsicData
                    .intrinsicToken;
