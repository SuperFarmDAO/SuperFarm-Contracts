...
contract FacetGroupUri is PermitControlds, ERC165Storage {
  ...
  */
    function setMetadata(uint256 _id, string memory _metadata) external {
        require(
            _hasItemRight(_id, BlueprintSuper1155.SET_METADATA),
        ...
        require(
            !b.uriLocked &&
                !b.metadataFrozen[_id] &&
                !b.metadataFrozen[groupId],
  ...
  */
    function lockGroupURI(string calldata _uri, uint256 groupId) external {
        require(
            _hasItemRight(groupId, BlueprintSuper1155.LOCK_ITEM_URI),
  ...
  */
    function lock()
        external
        virtual
        hasValidPermit(UNIVERSAL, BlueprintSuper1155.LOCK_CREATION)
    {
        BlueprintSuper1155.Super1155StateVariables
            storage b = BlueprintSuper1155.super1155StateVariables();
  ...
  */
    function lockURI(string calldata _uri, uint256 _id) external {
        require(
            _hasItemRight(_id, BlueprintSuper1155.LOCK_ITEM_URI),
  ...
  */
    function configureGroup(
        uint256 _groupId,
        BlueprintSuper1155.ItemGroupInput calldata _data
    ) external payable {
        require(_groupId != 0, "Super1155: group ID 0 is invalid");
        require(
            _hasItemRight(_groupId, BlueprintSuper1155.CONFIGURE_GROUP),
        ...
        if (!b.itemGroups[_groupId].initialized) {
            ...
            if (
                b.itemGroups[_groupId].supplyType ==
                BlueprintSuper1155.SupplyType.Capped
            ) {
                require(
                    _data.supplyType == BlueprintSuper1155.SupplyType.Capped,
                    "Super1155: you may not uncap a capped supply type"
                );
                require(
                    _data.supplyData <= b.itemGroups[_groupId].supplyData,
                ...
                _data.supplyType == BlueprintSuper1155.SupplyType.TimeValue
            ) {
                b.itemGroups[_groupId].supplyType = _data.supplyType;
                b.itemGroups[_groupId].timeData.timeStamp = block.timestamp;
                b.itemGroups[_groupId].timeData.timeInterval = _data
                    .timeData
                    .timeInterval;
                b.itemGroups[_groupId].timeData.timeRate = _data
                    .timeData
                    .timeRate;
            } else if (
                _data.supplyType == BlueprintSuper1155.SupplyType.TimePercent
            ) {
                require(
            ...
            require(
                _data.supplyData >= b.itemGroups[_groupId].circulatingSupply,
            ...
            if (
                b.itemGroups[_groupId].itemType ==
                BlueprintSuper1155.ItemType.Nonfungible
            ) {
                require(
                    _data.itemType == BlueprintSuper1155.ItemType.Nonfungible,
                ...
                require(
                    _data.itemType == BlueprintSuper1155.ItemType.Semifungible,
                    "Super1155: you may not alter nonfungible items"
                );
                ...
                if (_data.itemType == BlueprintSuper1155.ItemType.Nonfungible) {
                    require(
                        b.itemGroups[_groupId].circulatingSupply <= 1,
                        "Super1155: the fungible item is not unique enough to change"
                    );
                    b.itemGroups[_groupId].itemType = BlueprintSuper1155
                        .ItemType
                        .Nonfungible;
                    ...
                    require(
                        b.itemGroups[_groupId].circulatingSupply <=
                            _data.itemData,
                        "Super1155: the fungible item is not unique enough to change"
                    );
                    b.itemGroups[_groupId].itemType = BlueprintSuper1155
            ...
            b.itemGroups[_groupId].transferData.transferTime = _data
                .transferData
                .transferTime;
            b.itemGroups[_groupId].transferData.transferFeeAmount = _data
                .transferData
                .transferFeeAmount;
            b.itemGroups[_groupId].transferData.transferType = _data
                .transferData
                .transferType;

            // Update intrinsic value information.
            if (
                b.itemGroups[_groupId].intrinsicData.intrinsic &&
                b.itemGroups[_groupId].circulatingSupply == 0
            ) {
                b.itemGroups[_groupId].intrinsicData.rate = _data
                    .intrinsicData
                    .rate;
                b.itemGroups[_groupId].intrinsicData.burnShare = _data
                    .intrinsicData
                    .burnShare;
        ...
        if (
            _data.intrinsicData.intrinsicToken != address(0) &&
            _data.intrinsicData.prefund > 0
        ) {
            // Intrinsic token is ERC20
            b.itemGroups[_groupId].intrinsicData.prefund += _data
                .intrinsicData
                .prefund;
            b.itemGroups[_groupId].intrinsicData.totalLocked += _data
                .intrinsicData
                .prefund;
            IERC20(_data.intrinsicData.intrinsicToken).safeTransferFrom(
                _msgSender(),
                address(this),
                _data.intrinsicData.prefund
            );
        } else if (
            _data.intrinsicData.intrinsicToken == address(0) && msg.value > 0
        ) {
            // Intrinsic token is in Ether
