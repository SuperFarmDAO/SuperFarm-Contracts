...
abstract contract HolderClaim  {
    ...
    */
     ...
     */
    function addPool(PoolCreationStruct calldata _struct) external virtual {
    ...
    */
    ...
    function claim(uint256 _poolId, bytes32 _hash, Sig calldata sig, Checkpoint memory _checkpoints) external virtual {
