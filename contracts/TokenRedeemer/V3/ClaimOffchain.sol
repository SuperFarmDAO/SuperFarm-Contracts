...
*/
abstract contract ClaimOffchain is PermitControl, ReentrancyGuard {
  ...
  */
    constructor(address _burnAddress, address _adminAddress) {
    ...
    */
    function redeem(
        ...
        bytes32 _hash = keccak256(abi.encodePacked(mintableAmount));
        require(
            admin == ecrecover(prefixedHash(_hash), sig.v, sig.r, sig.s),
            "Signed not by trusted address"
        );
