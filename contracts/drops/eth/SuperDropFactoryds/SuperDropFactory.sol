  ...
  */
   ...
   */
    function createDrop(
        ...
        BlueprintSuperDropFactory.PoolConfigurationData[] memory _poolConfigurationData,
        ...
        superMintShop1155 = createMintShop(_owner, super1155, _mintShopCreateData, _poolInput, _poolConfigurationData, _whiteListCreate);

        // Store the Drop information
        BlueprintSuperDropFactory.Drop memory drop = BlueprintSuperDropFactory.Drop({
            owner: msg.sender,
            super1155: super1155,
        ...
        emit DropCreated(msg.sender, address(superMintShop1155), address(super1155), block.timestamp);
    ...
    */
    function createSuper1155( 
        ...
        // Deploy Super1155
        super1155 = address(new StorageSuper1155(linkProxy, _collectionName, _uri, _contractURI, _proxyRegistry));
    ...
    */
    function createMintShop(
        ...
        mintShop = address (new StorageSuperMintShop1155(linkProxy, _mintShopCreateData.paymentReceiver, _mintShopCreateData.globalPurchaseLimit, _mintShopCreateData.maxAllocation));
        ...
        IPermitControl(super1155).setPermit(mintShop, UNIVERSAL, BlueprintSuper1155.MINT, MAX_INT);
    ...
    */
     ...
     */
    function getExactDrop(bytes memory salt) external view returns (BlueprintSuperDropFactory.Drop memory) {
        return drops[salt];
    }
}
