...
contract FacetPools is SuperMerkleAccessds {
  ...
  */
    event PoolUpdated(
        address indexed updater,
        uint256 poolId,
        BlueprintSuperMintShop1155.PoolInput indexed pool,
        uint256[] groupIds,
        uint256[] caps,
  ...
  */
    function updatePaymentReceiver(address _newPaymentReceiver)
        ...
        hasValidPermit(
            UNIVERSAL,
            BlueprintSuperMintShop1155.SET_PAYMENT_RECEIVER
        )
    {
  ...
  */
    function setItems(ISuper1155[] calldata _items)
        external
        hasValidPermit(UNIVERSAL, BlueprintSuperMintShop1155.SET_ITEMS)
    {
        BlueprintSuperMintShop1155.SuperMintShop1155StateVariables
            storage b = BlueprintSuperMintShop1155
                .superMintShop1155StateVariables();
  ...
  */
    function lockPaymentReceiver()
        ...
        hasValidPermit(
            UNIVERSAL,
            BlueprintSuperMintShop1155.LOCK_PAYMENT_RECEIVER
        )
    {
        BlueprintSuperMintShop1155.SuperMintShop1155StateVariables
            storage b = BlueprintSuperMintShop1155
  ...
  */
    function updateGlobalPurchaseLimit(uint256 _newGlobalPurchaseLimit)
        ...
        hasValidPermit(
            UNIVERSAL,
            BlueprintSuperMintShop1155.UPDATE_GLOBAL_LIMIT
        )
    {
        BlueprintSuperMintShop1155.SuperMintShop1155StateVariables
            storage b = BlueprintSuperMintShop1155
        ...
        require(!b.globalPurchaseLimitLocked, "0x0A");
        emit GlobalPurchaseLimitUpdated(
            _msgSender(),
            b.globalPurchaseLimit,
  ...
  */
   ...
   */
    function addWhiteList(
    ...
    ) external hasValidPermit(UNIVERSAL, BlueprintSuperMintShop1155.WHITELIST) {
        BlueprintSuperMintShop1155.SuperMintShop1155StateVariables
            storage b = BlueprintSuperMintShop1155
                .superMintShop1155StateVariables();
        ...
        for (uint256 i = 0; i < whitelist.length; i++) {
            ...
            b.pools[_poolId].whiteLists[newIndex].id = whitelist[i]
                ._accesslistId;
  ...
  */
        ...
        returns (BlueprintSuperMintShop1155.PoolOutput[] memory)
    {
        ...
        BlueprintSuperMintShop1155.PoolOutput[]
            memory poolOutputs = new BlueprintSuperMintShop1155.PoolOutput[](
                _ids.length
            );
        for (uint256 i = 0; i < _ids.length; i++) {
            ...
            BlueprintSuperMintShop1155.PoolItem[]
                memory poolItems = new BlueprintSuperMintShop1155.PoolItem[](
                    b.pools[id].itemGroups.length
                );
            for (uint256 j = 0; j < b.pools[id].itemGroups.length; j++) {
                uint256 itemGroupId = b.pools[id].itemGroups[j];
                bytes32 itemKey = keccak256(
                    abi.encodePacked(
                        b.pools[id].config.collection,
                        b.pools[id].currentPoolVersion,
                        itemGroupId
                    )
                );

                // Parse each price the item is sold at.
                BlueprintSuperMintShop1155.Price[]
                    memory itemPrices = new BlueprintSuperMintShop1155.Price[](
                        b.pools[id].itemPricesLength[itemKey]
                    );
                for (
                    uint256 k = 0;
                    k < b.pools[id].itemPricesLength[itemKey];
                    k++
                ) {
  ...
  */
    function addPool(
        ...
        BlueprintSuperMintShop1155.Price[][] calldata _prices
    ) external hasValidPermit(UNIVERSAL, BlueprintSuperMintShop1155.POOL) {
        BlueprintSuperMintShop1155.SuperMintShop1155StateVariables
            storage b = BlueprintSuperMintShop1155
                .superMintShop1155StateVariables();
  ...
  */
    function updatePool(
        uint256 _id,
        BlueprintSuperMintShop1155.PoolInput calldata _config,
        uint256[] calldata _groupIds,
        uint256[] calldata _issueNumberOffsets,
        uint256[] calldata _caps,
        BlueprintSuperMintShop1155.Price[][] memory _prices
    ) public hasValidPermit(UNIVERSAL, BlueprintSuperMintShop1155.POOL) {
        BlueprintSuperMintShop1155.SuperMintShop1155StateVariables
            storage b = BlueprintSuperMintShop1155
                .superMintShop1155StateVariables();
  ...
  */
    function _updatePoolHelper(
        ...
        for (uint256 i = 0; i < _groupIds.length; i++) {
            ...
            bytes32 itemKey = keccak256(
                abi.encodePacked(
                    b.pools[_id].config.collection,
                    b.pools[_id].currentPoolVersion,
                    _groupIds[i]
                )
            );
            ...
            bytes32 key = keccak256(
                abi.encodePacked(b.pools[_id].config.collection, _groupIds[i])
            );
    ...
    function updatePoolConfig(
        ...
        require(
            _id <= b.nextPoolId && _config.endTime >= _config.startTime,
            "0x1A"
        );
        b.pools[_id].config = _config;
    }
    ...
    function isEligible(
        BlueprintSuperMintShop1155.WhiteListInput calldata _whiteList,
        uint256 _id
        ...
        return
            ((
                ...
                !b.pools[_id].whiteLists[_whiteList.whiteListId].minted[
                    _msgSender()
                ]) ||
            (block.timestamp >= b.pools[_id].config.startTime &&
                block.timestamp <= b.pools[_id].config.endTime);
    }
}
